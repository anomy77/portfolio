...
function App() {
  return (
    <div className="bg-black text-white font-sans min-h-screen selection:bg-white selection:text-black">
      ...
      {/* ===== SECTION 2: Value Proposition (White) ===== */}
      <section className="bg-white text-black py-32 md:py-48 px-8 md:px-16">
        <div className="max-w-6xl mx-auto">
          <motion.h2
            ...
            className="text-4xl md:text-7xl font-black tracking-tight leading-[1.05] mb-24 max-w-5xl uppercase"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border-t-2 border-black">
            {[
              ...
              <motion.div
                ...
                className="py-12 border-b-2 md:border-b-0 md:border-r-2 last:border-r-0 border-black md:px-8 first:md:pl-0 last:md:pr-0"
              >
                <p className="text-xs font-bold tracking-[0.2em] text-gray-400 mb-3">{item.label}</p>
